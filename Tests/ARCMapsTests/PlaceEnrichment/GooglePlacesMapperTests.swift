...
@Suite("GooglePlacesMapper Tests") struct GooglePlacesMapperTests {
    ...
    @Test("Maps address from formatted address") func mapsAddressFromFormattedAddress() {
        // Given
    ...
    @Test("Maps rating and user ratings total") func mapsRatingAndUserRatingsTotal() {
        // Given
    ...
    @Test("Maps price level") func mapsPriceLevel() {
        // Given
    ...
    @Test("Maps types array") func mapsTypesArray() {
        // Given
    ...
    @Test("Maps photo references") func mapsPhotoReferences() {
        // Given
    ...
    @Test("Handles nil types gracefully") func handlesNilTypesGracefully() {
        // Given
        let dto = createBasicDTO()
    ...
    @Test("Handles nil photos gracefully") func handlesNilPhotosGracefully() {
        // Given
        let dto = createBasicDTO()
    ...
    @Test("Maps to enriched data with all fields") func mapsToEnrichedDataWithAllFields() {
        // Given
    ...
    @Test("Maps opening hours correctly") func mapsOpeningHoursCorrectly() {
        // Given
    ...
    @Test("Maps reviews correctly") func mapsReviewsCorrectly() {
        // Given
    ...
    private func createBasicDTO() -> GooglePlaceResult {
        GooglePlaceResult(placeId: "place_123",
    ...
    private func createDTOWithPhotos(_ photoRefs: [String]) -> GooglePlaceResult {
        ...
        return GooglePlaceResult(placeId: "place_123",
                                 name: "Test Restaurant",
                                 formattedAddress: nil,
                                 geometry: GoogleGeometry(location: GoogleLocation(lat: 40.4168, lng: -3.7038)),
                                 rating: nil,
    ...
    private func createDTOWithOpeningHours() -> GooglePlaceResult {
        let openingHours = GoogleOpeningHours(openNow: true,
    ...
    private func createDTOWithReviews() -> GooglePlaceResult {
        let reviews = [GoogleReview(authorName: "John Doe", rating: 5, text: "Great place!", time: 1_609_459_200,
                                    language: "en")]
        return GooglePlaceResult(placeId: "place_123",
                                 name: "Test Restaurant",
                                 formattedAddress: nil,
