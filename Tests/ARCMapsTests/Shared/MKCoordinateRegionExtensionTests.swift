...
struct MKCoordinateRegionExtensionTests {
    ...
    func fittingSingleCoordinateProducesMinimumSpan() {
        // Given
    ...
    func fittingMultipleCoordinatesCentersCorrectly() {
    ...
    func fittingMultipleCoordinatesSpansFullExtent() {
        // Given
        let coords = [
